...
import (
	"flag"
	"galaxychain-graphql/cmd/apiserver/build"
	"galaxychain-graphql/internal/config"
	"galaxychain-graphql/internal/graphql/resolvers"
	"galaxychain-graphql/internal/handlers"
	"galaxychain-graphql/internal/logger"
	"galaxychain-graphql/internal/repository"
	"galaxychain-graphql/internal/svc"
	"log"
	"net/http"
	"os"
	"os/signal"
...
func (app *apiServer) run() {
	...
	app.log.Infof("welcome to GalaxyChain GraphQL API server")
