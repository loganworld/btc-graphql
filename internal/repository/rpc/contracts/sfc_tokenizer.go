...
var SfcTokenizerMetaData = &bind.MetaData{
	ABI: "[{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"_updateSGLXYTokenAddress\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"}],\"name\":\"allowedToWithdrawStake\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"}],\"name\":\"checkAllowedToWithdrawStake\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"redeemSGLXY\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"outstandingSGLXY\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"sGLXYTokenAddress\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"renounceOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"initialize\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"isOwner\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"toStakerID\",\"type\":\"uint256\"}],\"name\":\"mintSGLXY\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"}]",
}
...
// OutstandingSGLXY is a free data retrieval call binding the contract method 0x5b04f4c8.
//
// Solidity: function outstandingSGLXY(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerCaller) OutstandingSGLXY(opts *bind.CallOpts, arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _SfcTokenizer.contract.Call(opts, &out, "outstandingSGLXY", arg0, arg1)
...
//
// Solidity: function outstandingSGLXY(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerSession) OutstandingSGLXY(arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	return _SfcTokenizer.Contract.OutstandingSGLXY(&_SfcTokenizer.CallOpts, arg0, arg1)
}

// OutstandingSGLXY is a free data retrieval call binding the contract method 0x5b04f4c8.
//
// Solidity: function outstandingSGLXY(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerCallerSession) OutstandingSGLXY(arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	return _SfcTokenizer.Contract.OutstandingSGLXY(&_SfcTokenizer.CallOpts, arg0, arg1)
}
...
// SGLXYTokenAddress is a free data retrieval call binding the contract method 0x693c5e24.
//
// Solidity: function sGLXYTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerCaller) SGLXYTokenAddress(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SfcTokenizer.contract.Call(opts, &out, "sGLXYTokenAddress")
...
//
// Solidity: function sGLXYTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerSession) SGLXYTokenAddress() (common.Address, error) {
	return _SfcTokenizer.Contract.SGLXYTokenAddress(&_SfcTokenizer.CallOpts)
}

// SGLXYTokenAddress is a free data retrieval call binding the contract method 0x693c5e24.
//
// Solidity: function sGLXYTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerCallerSession) SGLXYTokenAddress() (common.Address, error) {
	return _SfcTokenizer.Contract.SGLXYTokenAddress(&_SfcTokenizer.CallOpts)
}

// UpdateSGLXYTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSGLXYTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) UpdateSGLXYTokenAddress(opts *bind.TransactOpts, addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "_updateSGLXYTokenAddress", addr)
}

// UpdateSGLXYTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSGLXYTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerSession) UpdateSGLXYTokenAddress(addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.UpdateSGLXYTokenAddress(&_SfcTokenizer.TransactOpts, addr)
}

// UpdateSGLXYTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSGLXYTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) UpdateSGLXYTokenAddress(addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.UpdateSGLXYTokenAddress(&_SfcTokenizer.TransactOpts, addr)
}
...
// MintSGLXY is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSGLXY(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) MintSGLXY(opts *bind.TransactOpts, toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "mintSGLXY", toStakerID)
}

// MintSGLXY is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSGLXY(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerSession) MintSGLXY(toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.MintSGLXY(&_SfcTokenizer.TransactOpts, toStakerID)
}

// MintSGLXY is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSGLXY(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) MintSGLXY(toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.MintSGLXY(&_SfcTokenizer.TransactOpts, toStakerID)
}

// RedeemSGLXY is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSGLXY(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) RedeemSGLXY(opts *bind.TransactOpts, stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "redeemSGLXY", stakerID, amount)
}

// RedeemSGLXY is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSGLXY(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerSession) RedeemSGLXY(stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.RedeemSGLXY(&_SfcTokenizer.TransactOpts, stakerID, amount)
}

// RedeemSGLXY is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSGLXY(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) RedeemSGLXY(stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.RedeemSGLXY(&_SfcTokenizer.TransactOpts, stakerID, amount)
}
