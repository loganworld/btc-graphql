...
const (
	...
	defApplicationName = "GalaxyChain GraphQL API Server (custom)"
	...
	defLachesisUrl = "\\\\.\\pipe\\galaxy.ipc" // ~/.lachesis/data/lachesis.ipc
	...
	defSfcContract = "0x1c1cb00000000000000000000000000000000000"
