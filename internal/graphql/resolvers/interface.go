...
type ApiResolver interface {
	...
	// LastStakerId resolves the last staker id in GLXY blockchain.
	LastStakerId() (hexutil.Uint64, error)

	// StakersNum resolves the number of stakers in GLXY blockchain.
	...
	// Price resolves price details of the GLXY blockchain token for the given target symbols.
