...
// OutstandingSGLXY resolves the amount of outstanding sGLXY tokens
// minted for this account.
func (del Delegation) OutstandingSGLXY() (hexutil.Big, error) {
	val, err := repository.R().DelegationOutstandingSGLXY(&del.Address, del.Delegation.ToStakerId)
	if err != nil {
		return hexutil.Big{}, err
	}
	return *val, nil
